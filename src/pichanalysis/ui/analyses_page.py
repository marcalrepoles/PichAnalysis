...
class AnalysesPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.save_organism = QPushButton("Salvar organismo")
        self.identifier = QLabel("—")
        self.identifier_type = QLabel("—")
        self.record_count = QLabel("0")
        form = QFormLayout()
        form.addRow("Organismo", self.organism)
        ...
        form.addRow("Tipo de identificador", self.identifier_type)
        ...
        self.progress.hide()
        self.summary = QLabel("Nenhum resultado disponível.")
        ...
        self.export_table = QPushButton("Exportar tabela...")
        self.export_workbook = QPushButton("Exportar workbook...")
        self.open_results = QPushButton("Abrir pasta de resultados")
        actions = QHBoxLayout()
    ...
    def set_project(self, project: Project | None) -> None:
        ...
        self.identifier.setText(str(design["primary_identifier_column"] or "Não configurado"))
        self.identifier_type.setText(str(design["primary_identifier_type"] or "Não configurado"))
    ...
    def show_outputs(self, outputs: MappingOutputs) -> None:
        ...
        self.summary.setText(
            ...
            f"Não mapeados: {meta.get('unmapped_count', 0)} | Incompatíveis: {meta.get('organism_mismatch_count', 0)}"
        )
